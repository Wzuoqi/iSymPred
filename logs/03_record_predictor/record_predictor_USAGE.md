...
`record_predictor.py` 是基于 16S rRNA 扩增子数据预测昆虫共生菌功能的工具。
...
```bash
python record_predictor.py -i sample.tsv -d record_db.tsv -o results.tsv
```
...
- **详细更新日志**: 查看 `record_predictor_CHANGELOG.md`
