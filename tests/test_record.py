...
"""
Unit tests for record predictor.
"""
...
from isympred.predictors import RecordPredictor


class TestRecordPredictor:
    """Test cases for RecordPredictor."""

    def test_predictor_initialization(self):
        """Test predictor initialization."""
        predictor = RecordPredictor(db_path="data/taxonomy_db")
    ...
    def test_predictor_with_host(self):
        ...
        predictor = RecordPredictor(db_path="data/taxonomy_db", host="Drosophila")
        assert predictor.host == "Drosophila"

    def test_load_model_file_not_found(self):
        """Test load_model raises error when database file not found."""
        predictor = RecordPredictor(db_path="nonexistent_path")
...
class TestRecordPredictorIntegration:
    """Integration tests for RecordPredictor (require database)."""
    ...
    def test_load_model_success(self, sample_taxonomy_db):
        ...
        predictor = RecordPredictor(db_path=str(sample_taxonomy_db))
        predictor.load_model()
    ...
    def test_query_by_genus_with_host(self, sample_taxonomy_db):
        ...
        predictor = RecordPredictor(db_path=str(sample_taxonomy_db), host="Drosophila")
        predictor.load_model()
